                ...
                <div className="row">
                  ...
                  <div className="col-sm-4">
                    <div className="form-group mb-2">
                      <input required onChange={this.onChange} value={cantidad || ""} type="number" className="form-control form-control frm_field" placeholder="Cantidad" name="cantidad" />
                  ...
                  <div className="col-sm-3">
                    <div className="form-group mb-2">
                      <input onChange={this.onChange} value={costo || ""} type="number" className="form-control form-control frm_field" placeholder="Costo" name="costo"
                        required />
                  ...
                  <div className="col-sm-2">
                    <div className="form-group mb-2">
                      <input required onChange={this.onChange} value={vendidas || ""} type="number" className="form-control form-control frm_field" placeholder="Vendidas" name="vendidas" />
                      <small className="form-text text-muted">* Vendidas</small>
                    </div>
                  </div>
                  <div className="col-sm-2">
                    <div className="form-group mb-2">
                      <input disabled onChange={this.onChange} value={total_cobrado || ""} type="number" className="form-control form-control frm_field" placeholder="Total cobrado" name="total_cobrado" />
                  ...
                  <div className="col-sm-2">
                    <div className="form-group mb-2">
                      <input disabled onChange={this.onChange} value={ganancia_neta || ""} type="number" className="form-control form-control frm_field" placeholder="Ganancia neta" name="ganancia_neta" />
